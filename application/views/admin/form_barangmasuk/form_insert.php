...
<head>
  ...
  <title>Stok Barang | Data Barang Masuk</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b>Benelan</b> Lor</span>
    </a>
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tanggal" style="margin-left:66px;width:20%;display:inline;" class="form-control form_datetime" required placeholder="Klik Disini">
                </div>
