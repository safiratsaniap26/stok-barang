...
<head>
  ...
  <title>Koperasi Desa Benelan Lor | Table Data Keluar</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b><b>Benelan</b> Lor</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example" class="table-excel display nowrap" style="width:100%">
        <thead>
            <tr>
                <th>No</th>
                <th>ID Transaksi</th>
        ...
        <tbody>
        <?php foreach($list_data as $key => $dd): ?>
            <tr>
            <td><?=$key+1?></td>
