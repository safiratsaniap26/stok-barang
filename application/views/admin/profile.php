...
<head>
  ...
  <title>Koperasi Desa Benelan Lor | User Profile</title>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?php } ?>
                <p>
                  <?=$this->session->userdata('name')?> - Web Stok Barang
                </p>
              </li>
              <!-- Menu Footer-->
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <p class="text-muted text-center">Pengelola Web Stok Barang</p><br>
